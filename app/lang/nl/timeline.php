...
return array(
    ...
    'header-text' => 'De Tijdlijn',

    'born-head' => 'Geboorte!',
    'born-body' => 'Ik kon nog niet veel op deze leeftijd, maar als ik terug kijk, denk ik wel dat geboren worden een van de meest essentiële aspected van mijn leven is.',
    ...
    'school-construction-head' => 'Afgestudeerd Middelbare School',
    'school-construction-body' => 'Ik ben afgestudeerd op het VMBO met een diploma kader bouw. Waardoor ik vervolgens naar het MBO4 ging',

    'buy-server-first-head' => 'Mijn eerste Linux VPS',
    'buy-server-first-body' => 'Dit is rond de tijd dat ik mijzelf meer serieus bezig ging houden met programmeren - Ik kon nog niet veel, maar er was voortgang!',

    'school-teachassistant-head' => 'Onderwijs Assistent',
    'school-teachassistant-body' => 'Van 2011 tot 2013 heb ik een opleiding Onderwijs Assistent gevolgt, daar heb ik veel geleerd over het lesgeven van, communicaren, plannen, en andere ' .
    ...
    'school-appdev-body' => 'Afgestapt van Onderwijs Assistent, momenteel studeer ik Applicatie Ontwikkelaar. De vaardigheden opgedaan van de voorafgaande jaren blijken hulpzaam te zijn, en ik vlieg door het programma..',
